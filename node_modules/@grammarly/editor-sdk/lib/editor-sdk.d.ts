...
declare interface EditorConfig {
    ...
    autocomplete?: string;
    /**
     * Use application dictionaries so that Grammarly stops flagging specific words as misspelled. {@link https://developer.grammarly.com/docs/dictionaries | Learn more}
     *
     ...
     *
     * @remarks Application dictionaries are available only on the Plus plan. {@link https://developer.grammarly.com/plans | Learn more} about our plans.
     * @defaultValue "off"
     * @public
     * @since v2.5.0
     */
...
/**
 * Callback functions for {@link https://developer.grammarly.com/docs/events | custom events} emitted by the Grammarly Text Editor Plugin.
 *
 * @public
 */
